        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
          ...
          <div className="flex-1 text-center lg:text-left space-y-6 order-1 lg:order-2">
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-3.5 justify-center lg:justify-start">
              <Link
                href="/projects"
                className="px-6 py-3.5 bg-[var(--accent-primary)] hover:bg-[var(--accent-primary-hover)] text-[var(--accent-primary-text)] font-bold rounded-2xl shadow-lg hover:shadow-xl transition duration-150 text-center flex items-center justify-center gap-2 text-sm"
              >
