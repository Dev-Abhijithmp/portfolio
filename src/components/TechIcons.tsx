...
export function KotlinIcon({ className = "w-5 h-5" }: IconProps) {
  return (
...
export function AndroidIcon({ className = "w-5 h-5" }: IconProps) {
  return (
...
export function FlutterIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function ShopifyIcon({ className = "w-5 h-5" }: IconProps) {
  return (
